-- Bandpass Filter
-- Biquad bandpass with inline coefficient computation. Stereo, wet/dry mix.
...
return {
    ...
    params = {
        ...
        { id="q",      label="Q",           min=0.1, max=20,    default=1.0,  type="float" },
    ...
    new = function(self, args)
        ...
        local function compute_bp(c, Q, s)
        ...
        local function recompute()
            ...
            b0, b1, b2, a1, a2 = compute_bp(c, Q, sr)
            dirty = false
        end
        ...
        function inst:on_message(inlet_id, msg)
            if msg.type == "float" then
                ...
                elseif inlet_id == "q"      then q      = msg.v; dirty = true
                end
            end
        end
